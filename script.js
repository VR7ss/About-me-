...
fetch("https://counterapi.dev/up/alhgys-team-3148/dryfd", {
  method: "GET",
  headers: {
    "Authorization": "Bearer ut_YAtpOcT1M7ig4uMmCIzwivTRpw1IjAmA1tuxDz0A"
  }
})
.then(response => response.json())
.then(data => {
  document.getElementById("viewCount").innerText = data.data;
})
.catch(err => {
